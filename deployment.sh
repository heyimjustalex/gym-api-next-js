...
echo "source $HOME/workspace/google-cloud-sdk/path.bash.inc" >> ~/.bashrc && source ~/.bashrc
echo "source $HOME/workspace/google-cloud-sdk/completion.bash.inc" >> ~/.bashrc && source ~/.bashrc
